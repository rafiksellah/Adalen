...
class JobApplication
{
    ...
    #[Assert\Length(min: 10, max: 10000, minMessage: 'Réponse trop courte', maxMessage: 'Réponse trop longue')]
    private ?string $motivationAdalen = null;

    #[ORM\Column(type: 'text')]
    #[Assert\NotBlank(message: 'Veuillez expliquer votre contribution')]
    #[Assert\Length(min: 10, max: 10000, minMessage: 'Réponse trop courte', maxMessage: 'Réponse trop longue')]
    private ?string $contributionAdalen = null;
    ...
    public function getMotivationFilename(): ?string
    {
        return $this->motivationFilename;
    }

    public function setMotivationFilename(?string $motivationFilename): self
    {
    ...
    public function getMotivationAdalen(): ?string
    {
        return $this->motivationAdalen;
    }

    public function setMotivationAdalen(string $motivationAdalen): self
    {
        $this->motivationAdalen = $motivationAdalen;
        return $this;
    }

    public function getContributionAdalen(): ?string
    {
        return $this->contributionAdalen;
    }

    public function setContributionAdalen(string $contributionAdalen): self
    {
        $this->contributionAdalen = $contributionAdalen;
        return $this;
    }
